...
const RebateTreasuryABI = [
  {
    inputs: [
      { internalType: 'address', name: 'AKSHARE', type: 'address' },
      { internalType: 'address', name: 'wineOracle', type: 'address' },
  ...
  {
    inputs: [{ internalType: 'address', name: 'AKSHARE', type: 'address' }],
    name: 'setWine',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
...
const Threeomb = new web3.eth.Contract(ERC20ABI, '0xEfB73202a463Ab78B674F64290fdaD6c75009Bf7');

const assetList = [
  '0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56', //BUSD
  '0xb45740a83aed18d2334448ab02e28b77738ed5e7', //AKUSD BUSD LP
  '0x2630b228e5a5f0153edb318914bf8e7e96e75c77', //AKSHARE  BUSD LP
];
...
function useRebateTreasury() {
  ...
  async function update() {
    const [tombPrice, tombBalance, vestedTomb, bondVesting, bondPremium, assetParams, assetPrices] = await Promise.all([
