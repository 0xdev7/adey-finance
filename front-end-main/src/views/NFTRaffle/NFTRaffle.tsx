...
const NFTRaffle: React.FC = () => {
  ...
  const handleBuyBonds = useCallback(
    async (amount: string) => {
      ...
      addTransaction(tx, {
        summary: `Send ${Number(amount).toFixed(2)} BUSD to the raffle ${amount} `,
      });
    },
          ...
          <>
            <Grid item xs={12} md={12} lg={12}>
              ...
              <p style={{ fontSize: '20px', textAlign: 'center', color: '#fff' }}>
                ...
                click the enter raffle button below to send 5 BUSD to the raffle address or manually send BUSD to the
              ...
              <p style={{ fontSize: '20px', textAlign: 'center', color: '#fff' }}>
                5 BUSD Per Entry, Unlimited Entries Per Wallet!<br></br>3 Winners will be selected!<br></br>
              ...
              <Grid container justify="center" spacing={3} style={{ marginTop: '10px', marginBottom: '20px' }}>
                <img alt="NFT Collage" style={{ width: '450px' }} src={Collage} />
              </Grid>

              <p style={{ fontSize: '20px', textAlign: 'center', color: '#fff' }}>
                Many thanks to our awesome partners for donating NFTs!<br></br>
                <a target={'_blank'} rel="noopener noreferrer" href={'https://www.eltacofinance.com/'}>
                  El Taco Finance
                </a>
                <br></br>
                <a target={'_blank'} rel="noopener noreferrer" href={'https://magik.finance/'}>
                  Magik Finance
                </a>
                <br></br>
                <a target={'_blank'} rel="noopener noreferrer" href={'https://app.mvfinance.club/'}>
                  Miniverse Finance
                </a>
                <br></br>
              </p>
            ...
            <Grid container justify="center" spacing={3} style={{ marginTop: '10px' }}>
              <Grid item xs={12} sm={12} lg={6}>
                <Card>
                  ...
                  <p style={{ textAlign: 'center' }}>Total BUSD entered: {raffleBals}</p>
                  <p style={{ textAlign: 'center' }}>Your BUSD entered: {userBals}</p>
