...
const Harvest = ({ bank }) => {
  ...
  } else if (bank.earnTokenName === 'AKUSD-BUSD-LP') {
      ...
      <CardContent>
        <StyledCardContentInner>
          <StyledCardHeader>
            ...
            <Typography style={{ textTransform: 'uppercase', color: '#212652' }}>
              <Value value={getDisplayBalance(earnings)} />
            </Typography>
            <Label
              text={
                bank.earnTokenName === 'AKUSD-BUSD-LP' || bank.earnTokenName === 'GRAPE-WLRS-LP'
                  ? `≈ $${earnedInDollarsLP}`
                  : `≈ $${earnedInDollars}`
              }
            />
